...
import torch
import numpy as np
from mapper.gsmap.gaussian_surfels.utils.graphics_utils import fov2focal, focal2fov
...
def depth2normal(depth, mask, fovx, fovy):
    ...
    p[..., 1:2] -= 0.5 * shape[0]
    p *= camD
    K00 = fov2focal(fovy, shape[0])
    K11 = fov2focal(fovx, shape[1])
